                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              <div class="form-group">
                                ...
                                <input type="color" name="heading_p_tag" required>
                              </div>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <div class="form-group">
                                ...
                                <input type="color" name="header_color" required>
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              <div class="form-group">
                                ...
                                <input type="form-control" class="form-control" name="first_name" required >
                              </div>
                            </div>
                          </div>
                          <div class="col-md-6">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="link" class="form-control" name="job_profile" required >
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label>Website</label>
                              <input type="website" class="form-control" name="website_link" required >
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label>Linkedin</label>
                              <input type="link" class="form-control" name="linkden_link" required >
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label>Youtube</label>
                              <input type="link" class="form-control" name="youtube_link" required >
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label>Division</label>
                              <input type="link" class="form-control" name="division" required >
                            </div>
                          </div>
                        </div>
                        <!-- File Upload start -->
